...
Singh et al.~\cite{Singh:2011:LCC:2002472.2002573} present an approach consisting of (1) a large scale distributed inference mechanism based on Markov chain Monte Carlo methods and (2) they introduce sub-entity and super-entity variables representing clusters which are used to distribute or collect certain entities on a specific part of the machine cloud.
...
\subfigure[Graph generated using $\rho=2$]
{
...
\goodgap
\subfigure[Graph generated using $M$ instead of $L$]{
\begin{tikzpicture}[auto,node distance=2cm,
  thick,main node/.style={circle,fill=blue!20,draw,font=\sffamily\bfseries}]
...
\caption{Graphs generated by our approach for the example dataset.}
\end{figure}
