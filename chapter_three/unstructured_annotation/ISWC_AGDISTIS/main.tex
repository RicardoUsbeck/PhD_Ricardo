...
%ECAI: \title{AGDISTIS - Agnostic Disambiguation of Named Entities Using Linked Open Data}
...
Andreas Both$^{2}$
\institute{
${^1}$ University of Leipzig, Germany , ${^2}$ R\,\&\,D, Unister~GmbH, Germany, ${^3}$ Federal University of Juiz de Fora, Brazil, ${^4}$ University of Bonn \& Fraunhofer IAIS, Germany
...
\begin{figure}[htb!]\centering
        \includegraphics[width=0.9\linewidth]{fig/reuters.pdf}
