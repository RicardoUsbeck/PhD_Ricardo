...
\usepackage{todonotes}
    \newcommand{\todoanbo}[1]{\todo{AnBo: #1}}
\usepackage{booktabs}
\usepackage{multirow}
% START: algorithm description and math functions (Disheng)
...
\begin{figure*}[h!tb]
        \centering
        \subfloat[Directors from IMDB, prominence-based sampling]{\label{fig:pDirector}\includegraphics[width=.33\textwidth]{no-random-director.pdf}}~
        \subfloat[Actors from IMDB, prominence-based sampling]{\label{fig:pActors}\includegraphics[width=.33\textwidth]{no-random-starring.pdf}}~
        \subfloat[Authors from Goodreads, prominence-based sampling]{\label{fig:pAuthor}\includegraphics[width=.33\textwidth]{no-random-author.pdf}}

        \subfloat[Directors from IMDB, uniform sampling]{\label{fig:uDirector}\includegraphics[width=.33\textwidth]{random-director.pdf}}~
        \subfloat[Actors from IMDB, uniform sampling]{\label{fig:uActors}\includegraphics[width=.33\textwidth]{random-starring.pdf}}~
        \subfloat[Authors from Goodreads, uniform sampling]{\label{fig:uAuthor}\includegraphics[width=.33\textwidth]{random-author.pdf}}
        
        \subfloat[Teams from ESPNFC, prominence-based sampling]{\label{fig:pTeam}\includegraphics[width=.33\textwidth]{no-random-team.pdf}}~
        \subfloat[Teams from ESPNFC, uniform sampling]{\label{fig:uTeam}\includegraphics[width=.33\textwidth]{random-team.pdf}}~
        \subfloat[Average computational time and F-measure over all datasets]{\label{fig:runtime}\includegraphics[width=.33\textwidth]{time-F.pdf}}
...
%Still, when a small number of examples $|E|$ is provided, the uniform sampling returns better results than the prominence-based sampling (compare results with $|E| = 10k$ on Figures~\ref{fig:pDirector} and~\ref{fig:uDirector}, Figures~\ref{fig:pActors} and~\ref{fig:uActors}, Figures~\ref{fig:pAuthor} and~\ref{fig:uAuthor} as well as Figures~\ref{fig:pTeam} and~\ref{fig:uTeam}) in all settings.  
...
% \end{itemize}
% \item In Figure~\ref{fig:overall-XPaths} we show the quality of the learned XPaths considering as input a given number of pairs.
