...
Here, FRED reuses various frameworks like Boxer~\citep{Bos:2008:WSA:1626481.1626503} and TagMe2~\cite{TagMe2} to be able to spot not only the common types like person, organizations and places but also events.
...
Supervised approaches were yet deemed costly due to the human labor necessary to annotate the input websites. 
