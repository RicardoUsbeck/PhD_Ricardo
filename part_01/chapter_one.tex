...
With the proposed Semantic Web vision~\cite{bernerslee2001semantic}, Lee et al. suggested an extenstion of the existing Web to allow for better reuse, sharing and understanding of data. % by introducing novel W3C\footnote{World Wide Web consortium \url{http://www.w3.org/}} standards. 
%taken from HAWK
