...
% aligned dottedtoc manychapters
...
% ****************************************************************************************************
\newcommand{\myTitle}{Knowledge Extraction for Hybrid Question Answering}
...
\newcommand{\myTime}{January 2013 - March 2016\xspace}
...
% RU: used to print single publication with full reference
 \usepackage{bibentry}
 \nobibliography*
...
\usepackage{enumitem} %spacing between enumerations in abstract
...
\usepackage{enumitem}
\usepackage{etoolbox}
%% Acronyms start new in each chapter
