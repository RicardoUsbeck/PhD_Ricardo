...
Figure~\ref{fig:hawk_pipeline} gives an overview of the architecture and the pipeline steps of HAWK. In the following we describe the depicted steps in more detail.%: POS-tagging, entity annotation, dependency parsing, linguistic pruning, semantic annotation, SPARQL query generation, pruning and ranking.
