...
While manifold annotation tools have been developed over the last years to address (some of) the subtasks related to the extraction of structured data from unstructured data \cite{TagMe2,AIDA,spotlight,milne2008learning,babelfy,piccinno2014tagme,rizzo2014,steinmetz-n-2013-statistical,agdistis_iswc}, the provision of comparable results for these tools remains a tedious problem.
