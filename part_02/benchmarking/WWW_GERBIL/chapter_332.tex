...
\todo[inline]{@Me: Verknüpfung mit AGDISTIS herstellen}
...
\todo[inline]{@Me: Vgl zum intro herstellen}
...
\todo[inline]{@Micha: Stimmt das noch oder sollte hier ein Link zum Update Chapter hin?}
...
\todo[inline]{@Micha: Was meint many-to-one?}
...
\end{figure}
\todo[inline]{@Me: Redo graphics user\_study.eps}
...
\label{fig:runtime}
\end{figure}
\todo[inline]{@Me: Redo graphics needed\_times.eps}
