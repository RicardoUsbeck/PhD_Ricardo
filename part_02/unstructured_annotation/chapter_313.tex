...
\graffito{
This chapter presents CETUS, a pattern-based approach for annotation RDF type information to entities.
CETUS has won the OKE challenge 2015~\cite{okechallenge}, task 2, and is published in~\cite{CETUS_2015}.
The author of this thesis assisted the main author, co-wrote the paper and its poster. 
}
\todo[inline]{Adapt the introduction to the aforementioned AGDISTIS section}
\todo[inline]{Replace listings by algorithms}
...
\begin{figure}[tb!]
\centering
\includegraphics[scale=0.7]{part_02/unstructured_annotation/fig/localYAGOHierarchy.pdf}
