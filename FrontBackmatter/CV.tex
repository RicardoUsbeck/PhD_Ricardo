...
\begin{tabular}{p{3cm}p{10cm}}	
2016        & ESWC (reviewer), WebNLG (review),NLIWoD (PC), QALD (PC), NLP \& DBpedia (PC), WebNLG (PC), TKDE (review), BLINK@ISWC (PC), KEKI@ISWC (PC), Poster \& Demo ISWC (PC),  SPARQL Query Benchmarking Tutorial@ISWC (organizer), W3C CG meetup@SEMANTiCS (organizer)\\
