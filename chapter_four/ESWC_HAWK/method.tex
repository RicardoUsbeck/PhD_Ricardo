...
Figure~\ref{fig:architecture} gives an overview of the architecture of HAWK. In the following we describe the depicted steps in more detail.%: POS-tagging, entity annotation, dependency parsing, linguistic pruning, semantic annotation, SPARQL query generation, pruning and ranking.

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{HAWK_architecture}
...
Figure~\ref{fig:prunedtree} depicts the predicate-argument tree obtained for our running example after pruning.% of unnecessary nodes.

\input{algo_treepruner.tex}

\begin{minipage}{0.57\textwidth} 
\centering
\includegraphics[width=\linewidth]{hawk_tree_full}
...
\centering
\includegraphics[width=\linewidth]{hawk_tree_pruned}
